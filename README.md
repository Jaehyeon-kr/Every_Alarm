...
```
Every_Alarm/ Yolo 코드 실행은 Root를 이 폴더로 진행합니다. 
├── README.md
├── dataset.yaml
│
├── scripts/                       #Yolo 관련 Python 스크립트 정리
...
| 🚗 **자동차 피하기** | ⭐⭐⭐ 어려움 | 7번 연속 회피 | 집중력과 반사신경 테스트 |
...
- when you have Issues, Please Contact me or leave Issues at Github.
