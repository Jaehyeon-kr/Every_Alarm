...
# Every_Alarm: Set Your Semester Alarms Effortlessly!
##
![img](white_test.jpg)
...
데이터는 많을 수록 성능이 좋아질 수 있으나, 저는 컴퓨터나 노트북의 저장공간을 생각하여 10000여개의 데이터를 생성했습니다.

이때 이미지의 저장경로는 ./datasets에 저장됩니다. 아래는 화이트 샘플과 블랙 샘플 2개 예시입니다.
